...
async def slide_writer(state: PPTGenerationState) -> dict:
    ...
    if use_diagram_images:
        diagram_section = (
            ...
            "- `mermaid` (PREFERRED) — flowcharts (graph TD/LR), sequence diagrams, class diagrams, ER diagrams. Most reliable.\n"
            "- `plantuml` — detailed sequence diagrams, component diagrams, activity diagrams\n"
            "- ALWAYS use `mermaid` unless you have a specific reason for another type.\n\n"
            "### RULES:\n"
